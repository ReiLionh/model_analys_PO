...
Цель код-ревью — системное улучшение качества кода и обмен знаниями. 

Задачи: найти логические ошибки, проверить соответствие архитектурным принципам, убедиться в читаемости и соблюдении стиля, выявить потенциальные проблемы с безопасностью или производительностью. 
